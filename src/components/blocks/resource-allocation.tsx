...
const topItems = [
  ...
  },
  {
    ...
    description:
      "Align cloud, identity, data, and technology programs with measured enterprise risk.",
    images: [
    ...
    >
      <div className="">
        <h2 className="container text-center text-3xl tracking-tight text-balance sm:text-4xl md:text-5xl lg:text-6xl">
          Engagements built around clear priorities and defensible recommendations
        </h2>
  ...
  return (
    ...
    >
      ...
      {item.fade.includes("bottom") && (
        <div className="from-muted/80 absolute inset-0 z-10 bg-primary-to-t via-transparent to-transparent md:hidden" />
      )}
